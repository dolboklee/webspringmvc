...
@WebServlet(urlPatterns= {"/hello2", "/hello"}) // 추천 X
public class HelloServlet extends HttpServlet{
	
	
	
	@Override
	public void init(ServletConfig config) throws ServletException { // 최초 생성될 때에만 호출
	...
	@Override
	public void init() throws ServletException {	// 최초 생성될 때에만 호출
